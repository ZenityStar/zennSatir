       ...
       if (args[0] == 'rod'){
         ...
         if (args[1] == 'kayu') 
         {
           if (invu.moneyfish < kays) throw 'Uang kurang'
             ...
             if (invu.moneyfish < bats) throw 'Kamu tidak mempunyai uang kak'
            ...
            if (invu.moneyfish < bass) throw 'Kamu tidak mempunyai uang kak'
          ...
          if (invu.moneyfish < gols) throw 'Kamu tidak mempunyai uang kak'
          if (invu.moneyfish > gols) {
            ...
            if (invu.moneyfish < dias)  throw 'Kamu tidak mempunyai uang kak'
            ...
            if (invu.moneyfish < nets) throw 'Kamu tidak mempunyai uang kak'
            ...
            if (user.raihan == false) throw 'Kamu Bukan Zenn'
            if (user.raihan == true) {
              conn.reply(m.chat, `Zenn berhasil mengambil rod nya`) 
              invu.rod = '*Zenn*'
